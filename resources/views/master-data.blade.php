                ...
                <form action="{{ route('categories.store') }}" method="POST" id="categoryForm" class="mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="category_type" name="type" class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm" required>
